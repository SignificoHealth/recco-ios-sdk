...
final class SFNotificationView: UIView {
    ...
    private lazy var container: UIView = {
        ...
        container.backgroundColor = .sfBackground
        container.layer.cornerRadius = .XXS
        container.layer.shadowColor = UIColor.sfOnBackground.cgColor
    ...
    private lazy var subtitleLb: UILabel = {
        ...
        subtitleLb.textColor = .sfPrimary
...
extension UIWindow {
    ...
    public func showHCNotification(
        title: String,
        subtitle: String? = nil,
        duration: Int = 3,
        completion: @escaping () -> Void
